    ...
    <div class="card-header py-3">
      <div class="d-flex justify-content-between">
        ...
        <div class="d-flex justify-content-start">
          ...
          />
          <div v-if="selectedArtikelIds.length == 0"></div>
          <ButtonComponent
            Color="btn-danger"
            Icon="fa-trash"
            v-else-if="selectedArtikelIds"
            Message="hapus"
...
export default {
  ...
  methods: {
    ...
    postArtikel() {
      const url =
        'https://rafliseptiannn25.web.ti.polindra.ac.id/smarthealth_api/public/api/master/artikel'
      const config = {
        headers: {
